...
<head>
  ...
  <title>Dyna Shop - Contact Us</title>
  ...
  <style>
    .btn-gmail {
      background: linear-gradient(135deg, #f15a24 0%, #d94c1a 100%);
      color: white;
      border: none;
      padding: 14px 30px;
      font-size: 16px;
...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>Contact Us</h3>
          <span class="breadcrumb"><a href="home.php">Home</a> > Contact Us</span>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-lg-6">
          <div class="right-content">
            <div class="row">
              <div class="col-lg-12">
                <div id="map">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d1690.2787581609705!2d120.50495133810445!3d16.015578212243827!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2sth!4v1774255818859!5m2!1sen!2sth" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
              </div>
              <div class="col-lg-12">
                <div class="col-lg-12">
                  <fieldset>
                    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=mrkpulsrmnt12@gmail.com" target="_blank" class="btn-gmail" id="form-submit">
                      <i class="fa fa-envelope"></i> Send Email via Gmail
                    </a>
                  </fieldset>
                </div>
              </div>
  ...
  <footer>
    <div class="container">
      <div class="col-lg-12">
        <p style="text-align: center; padding: 20px 0;">© 2025 Dyna Shop. All Rights Reserved.</p>
      </div>
    </div>
  </footer>
